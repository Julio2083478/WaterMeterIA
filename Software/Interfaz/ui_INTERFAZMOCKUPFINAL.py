...
################################################################################
## Form generated from reading UI file 'INTERFAZMOCKUPFINALfvKenV.ui'
##
...
"")
        ...
        self.pushButton = QPushButton(self.frame_lateral)
...
"")
        icon4 = QIcon()
        icon4.addFile(u"ICONOS/CEMOS-removebg-preview.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton.setIcon(icon4)
        self.pushButton.setIconSize(QSize(130, 80))
...
"")
        icon5 = QIcon()
        icon5.addFile(u"ICONOS/LOGO UIS_PNG.png", QSize(), QIcon.Normal, QIcon.Off)
        self.logo_uis.setIcon(icon5)
...
"background-color: #90CAF9;")
        icon6 = QIcon()
        icon6.addFile(u"ICONOS/PLUS_WHITE.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_newref.setIcon(icon6)
...
"background-color:#90CAF9;")
        icon7 = QIcon()
        icon7.addFile(u"ICONOS/X_WHITE.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_x.setIcon(icon7)
...
"}")
        icon8 = QIcon()
        icon8.addFile(u"ICONOS/ICONO_BORRAR_REF.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon9 = QIcon()
        icon9.addFile(u"ICONOS/ICONO_BORRADOR.png", QSize(), QIcon.Normal, QIcon.Off)
        self.icono_new_ref_2.setIcon(icon9)
...
"}")
        icon10 = QIcon()
        icon10.addFile(u"ICONOS/NEW_REF.png", QSize(), QIcon.Normal, QIcon.Off)
        self.icono_new_ref.setIcon(icon10)
...
"}")
        icon11 = QIcon()
        icon11.addFile(u"ICONOS/A\u00d1ADIR_ARCHIVO_LOGO.png", QSize(), QIcon.Normal, QIcon.Off)
        self.anadir.setIcon(icon11)
...
"background-color: #ffffff;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\">Autores: </p><p align=\"center\">Julio Andr\u00e9s Sanchez Abello </p><p align=\"center\">&amp; </p><p align=\"center\">Katherine Paola Parra Tarazona</p></body></html>", None))
        ...
        self.cb_uso.setItemText(1, QCoreApplication.translate("MainWindow", u"COMERCIAL", None))
